...
1. **Marketing ROI & Acquisition Quality:** Which marketing campaigns bring in _high-intent_ users (highest Quality View Rate) rather than just clickbait traffic?
...
3. **Product Feature Effectiveness:** Does the _Autoplay_ feature genuinely increase user engagement, or does it contribute to a higher Bounce Rate?
...
- **Product:** _Autoplay_ is highly effective, yielding a 43.1% completion rate with a lower bounce rate compared to manual play, proving its value in driving binge-watching behavior.
...
- `analysis_dataset.ipynb`: The core Python notebook containing the ETL process, data cleaning logic, chunking iteration, and EDA.
